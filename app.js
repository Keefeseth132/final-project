...
app.get('/', passportConfig.ensureAuthenticated, indexController.index);

app.get('/about', passportConfig.ensureAuthenticated, indexController.about);
app.get('/new-cannabis', passportConfig.ensureAuthenticated, indexController.newCannabis);
app.get('/suggestions', passportConfig.ensureAuthenticated, indexController.suggestions);

app.get('/api/suggestion', passportConfig.ensureAuthenticated, indexController.getSuggestions)
app.post('/newsuggestion', passportConfig.ensureAuthenticated, indexController.newSuggestion)

app.get('/api/strains', passportConfig.ensureAuthenticated, indexController.getStrains)
